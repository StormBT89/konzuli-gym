      ...
      <div className='flex flex-col bg-slate-950 rounded gap-2 p-2'>
        ...
        <div className='grid grid-cols-2 sm:grid-cols-4 sm:place-items-center gap-2'>
            {['reps', 'rest', 'tempo'].map(info => {
             ...
             <button onClick={handleSetIncrement} className='flex flex-2 p-2 rounded border-[1.5px] duration-200
             border-solid border-blue-900 hover:border-blue-600 w-full duration-200'>
                <h3 className='text-slate-400 text-sm capitalize'> Завршена серија  -</h3>
